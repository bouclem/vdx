  ...
  return (
    <div className="max-w-5xl mx-auto px-6">
      ...
      <section className="pt-24 pb-20">
        ...
        <p className="text-[var(--vdx-muted)] text-sm font-mono mb-4">v0.1.4 — by Voidware</p>
      ...
      <section className="pb-24">
        <div className="border border-[var(--vdx-border)] rounded-lg overflow-hidden bg-[var(--vdx-surface)]">
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-[var(--vdx-border)]">
            ...
            <span className="text-xs text-[var(--vdx-muted)]">VDX 0.1.4</span>
          </div>
      ...
      <section className="pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-8">
          ...
          <div>
            ...
            <p className="text-[var(--vdx-muted)] text-sm leading-relaxed">
              Built-in <code className="text-[var(--vdx-accent)]">graph</code> module generates SVG plots — scatter, line, bar, histogram, and area charts with color, grid, and legend support.
            </p>
          </div>
          <div>
